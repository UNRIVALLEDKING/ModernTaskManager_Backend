...
const nodePass = process.env.NODEPASS;
var transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "vidyarthivilla@gmail.com",
    pass: nodePass,
  },
});
...
const addSubsriberApi = async (req, res) => {
  ...
  var vidyarthivillaMail = "vidyarthivilla@gmail.com";

  const checkUser = await VidyarthiVillaModels.findOne({ email: email });
  var mailOptions = {
    from: vidyarthivillaMail,
    to: email,
    subject:
      "Welcome to Vidyarthivilla - Thanks for subscribing to our newsletter!",
    ...
    border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;" width="100%" valign="top"><div class="definition-parent"><span></span></div></td></tr></tbody></table></div>
    </div>
                </div>
            </div>
    ...
    border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;" width="100%" valign="top"><div class="definition-parent"><span><table align="center" width="100%" class="floated-none" style="float: none; text-align: center; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;" role="presentation">
      <tbody><tr>
        <td align="center" style="padding: 0px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
          <a class="aw-image-link" href="http://vidyarthivilla.com" style="border-width: 0px; border-style: none; text-decoration: none;" target="_blank" rel="noopener noreferrer">
          <img class="model" src="https://i.ibb.co/Bz9Frqq/image.png" style="display: block; width: 600px; height: 283px; border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 10px;" alt="Image" width="600" height="283">
          </a>
        </td>
      </tr>
    ...
    <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">Welcome to VidyarthiVilla - the student community that is focused on helping students achieve their academic goals while having fun and building lifelong connections.</p>
                      <br/>
                      <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">Thank you for subscribing to our newsletter and joining us on this exciting journey. As a VidyarthiVilla subscriber, you will receive regular updates on our latest events, programs, and exclusive resources that are designed to help you succeed.</p>
                      
                      <br/>
                      
                      <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">Our team is dedicated to creating a supportive and engaging community that empowers students to thrive academically and personally. With your support, we can continue to grow and make a positive impact on the lives of students like you.</p>
                      
                        <br/>
                      
                      <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">We are currently working on some exciting new initiatives that we can't wait to share with you. From academic support programs to social events, we have something for every student at VidyarthiVilla.</p>
                      
                        <br/>
                      
                      <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">Thank you again for subscribing to our newsletter. We look forward to connecting with you soon and helping you achieve your goals.</p>
                        <br/>
                      
                      <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">Best regards,</p>
                      
                      <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">VidyarthiVilla Team</p>
    </div></div></div>
      <div class="divider">
              ...
              <tr>
                <td class="divider-container" style="padding: 10px 0px 20px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
                  <table width="100%" role="presentation" style="border-width: 1px 0px 0px; border-style: solid none none; border-top-color: rgb(222, 224, 232); border-collapse: collapse; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-spacing: 0px; font-size: 18px;">
                    <tbody>
                      <tr>
                        <td width="100%" style="text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;"></td>
                      </tr>
                    </tbody>
                  </table>
                </td>
    ...
    </div><div class="definition-parent"><div class="text-element paragraph"><div style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
    ...
    <div style="text-align: center; color: rgb(124, 124, 124); font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 125%; font-weight: 400;">Patna, Bihar, India</div>
